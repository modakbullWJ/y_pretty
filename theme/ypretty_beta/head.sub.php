...
?>
<!-- main_slider.php 슬라이드 js 추가 wj-->
<script src="<?php echo G5_THEME_URL ?>/js/jquery.bannerSlider-1.0.js"></script>
<!--  jquery css 추가-->
<script src="<?php echo G5_THEME_URL ?>/css/jqueryCSS.css"></script>

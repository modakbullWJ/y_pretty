...
<!-- <section id="sct_sort"> -->
    ...
    <ul class="prd_align">
        <li><a href="<?php echo $sct_sort_href; ?>it_sum_qty&amp;sortodr=desc">판매순</a></li>
        <li><a href="<?php echo $sct_sort_href; ?>it_update_time&amp;sortodr=desc">신상품순</a>&nbsp;Ι&nbsp;</li>
        <li><a href="<?php echo $sct_sort_href; ?>it_price&amp;sortodr=desc">높은가격순</a>&nbsp;Ι&nbsp;</li>
        <li><a href="<?php echo $sct_sort_href; ?>it_price&amp;sortodr=asc">낮은가격순</a>&nbsp;Ι&nbsp;</li>
